...
def evaluate(opt):
    ...
    # assert opt.eval_split == "o_9" or opt.eval_split == "odom_10", \
    #     "eval_split should be eitdomher odom_9 or odom_10"
    ...
    print("{:0.3f}\t{:0.3f}".format(np.mean(ates), np.std(ates)))
    # save_path = os.path.join(opt.load_weights_folder, "poses_{:02d}.npy".format(sequence_id))
